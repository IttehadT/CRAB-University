  ...
  return (
    <div className="bg-background font-sans text-foreground dark:bg-slate-950 dark:text-slate-50">
      ...
      <section id="features" className="container mx-auto py-20 px-4">
        <h2 className="mb-10 text-center text-3xl font-bold dark:text-white">Explore Features</h2>
        ...
        <div className="container mx-auto grid gap-12 px-4 md:grid-cols-2 md:items-center">
          <div>
            <h2 className="text-3xl font-bold leading-tight md:text-5xl">
              Why I Built <span className="text-blue-400">{siteConfig.brand?.name || "CRAB University"}</span>
            </h2>
